...
GZ::CTF is open source under AGPLv3 license, use and modification are subject to the open source license. Please refer to [Quick Start](/guide/start/quick-start) for deployment.
