...
You can find the installation instructions on the [Docker official website](https://docs.docker.com/engine/install/), and use the basic configuration in [Quick Start](/guide/start/quick-start) to run GZCTF.
...
If you don't want to use Docker as a container backend, but need to deploy on a single machine, you can refer to the method in [K8s Cluster Deployment](/guide/deployment/k8s-only).
